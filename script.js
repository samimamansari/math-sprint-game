...
function updateBestScore(){
  bestScoreArray.forEach((score,index)=>{
    ...
    if(questionAmount == score.questions){
      ...
      // Update if the new final score is less or replace with 0
...
// Scroll,store user selectio  in playerGuessArray
...
function equationsToDOM(){
  equationsArray.forEach((equation) => {
    ...
    equationText.textContent = equation.value;console.log(equation.value);
    // Appenf
